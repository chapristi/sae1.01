...
if __name__ == "__main__":
    ...
    while player1.id == -1:
        ...
        if int(choice) == 0:
            ...
            botLvl = input("Entrez le niveau du bot (1 à 6)")
            while not isDigit(botLvl) or not (1 <= int(botLvl) <= 6):
                botLvl = input(setColorYellow("⚠️ entrez le niveau du bot de 1 à 6"))
